...
public class ProcessEnginesTest {
	...
	public void testBean() {
		ApplicationContext ac = new GenericXmlApplicationContext("/META-INF/activiti-context.xml");
		Map<String, ProcessEngine> beanTypes = ac.getBeansOfType(ProcessEngine.class);
		ProcessEngine pe = beanTypes.values().iterator().next();
	...
	public void genericXmlApplicationContext() throws Exception {
		...
		Enumeration<URL> resources = classLoader.getResources("activiti-context.xml");
	...
	public void testShareniuLifecycleListener() throws Exception {
		ProcessEngineConfiguration pc = ProcessEngineConfiguration.createProcessEngineConfigurationFromResource(
				"com/shareniu/chapter2/lifecyclelistener/activiti.cfg.xml");
